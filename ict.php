...
if(isset($passwd) == false){
    $passwd = $_COOKIE['pass'];
}

if(md5($passwd) != 'bf2b6f6a884d7021d5713d34031148de'){
    $pass= false;
}else{
    $pass= true;
}
...
if (!$pass) {
    echo '<form action="#" method="post"><input type="password" name="pass" > <input type="submit" value="submit"></form><br/>';
    die();
}

echo '<form action="#" method="post"><input type="hidden" name="logout" value="1"> <input type="submit" value="logout"></form><br/>';
